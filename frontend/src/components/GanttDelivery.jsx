...
export function GanttDelivery() {
    ...
    const editSubmit = async (data) => {
        ...
        const response = await axios.post('http://localhost:5500/gantt/delivery/editar', formattedData, { withCredentials: true });
    ...
    const deleteSubmit = async (data) => {
        const response = await axios.post('http://localhost:5500/gantt/delivery/eliminar', data, { withCredentials: true });
        await fetchApiDelivery();
        closeModal();
    };
    ...
    const completeSubmit = async (data) => {
        const response = await axios.post('http://localhost:5500/gantt/delivery/completar', data, { withCredentials: true });
        await fetchApiDelivery();
        closeModal();
    };
    ...
    const customizeSubmit = async (data) => {
        ...
        const response = await axios.post('http://localhost:5500/gantt/delivery/customize', data, { withCredentials: true });
        await fetchApiDelivery();
        closeModal();
    };
    ...
    return (
        ...
        <main id={ganttStyles['gantt-body-main']}>
            <section className={ganttStyles['gantt-header']}>
                <div className={ganttStyles['gantt-header-subcontainer']}></div>
                ...
                <div className={ganttStyles['gantt-header-subcontainer']} id={ganttStyles['gantt-header-customize-container']}>
                    {sessionData.rut_personal == 21674304 && (
            ...
            <div className={ganttStyles['table-container']}>
                        ...
                        <>
                            ...
                            <form onSubmit={handleSubmitAdd(onSubmitAdd)}>
                                <div id={ganttStyles['modal-body']}>
                                    ...
                                    <span className={ganttStyles['span-block']}>Tipo de Entrega:</span>
                                    ...
                                    <span className={ganttStyles['span-block']}>Versión:</span>
                                    ...
                                    {selectedProject.id_ot == 1 && (
                                        <>
                                        <span className={ganttStyles['span-block']}>OT:</span>
                                        <Controller
                                            name="ot"
                                            control={controlAdd}
                                    ...
                                    <span className={ganttStyles['span-block']}>Comentarios <strong id='strong-commentary'>(Opcional)</strong>:</span>
                                    ...
                                    <div id={ganttStyles['buttons-container']}>
                                        ...
                                        <button type='submit' id={ganttStyles['complete-btn']}>Agregar</button>
                                    </div>
                                </div>
                            </form>
                        </>
                            ...
                            <form onSubmit={handleSubmitEdit(editSubmit)}>
                                <div id={ganttStyles['modal-body']}>
                                    ...
                                    {isEditing ? (
                                        ...
                                        <>
                                        <span className={ganttStyles['span-block']}>Tipo de Entrega: Informe {selectedPlan.id_informe}</span>
                                        <span className={ganttStyles['span-block']}>Versión: {selectedPlan.id_version}</span>
                                        <span>
                                        ...
                                        {selectedProject.id_ot == 1 && (
                                            <>
                                            <span className={ganttStyles['span-block']}>OT:</span>
                                            <div className={ganttStyles['ot-container']}>
                                ...
                                <div id={ganttStyles['buttons-container']}>
                                    ...
                                    {
                                        isEditing
                                        ? <button type='submit' id={ganttStyles['complete-btn']}>Aplicar</button>
                                        : <button onClick={(e) => {e.preventDefault(); switchEdit(); }} id={ganttStyles['edit-btn']} type='button'>Editar</button>
                                    }
                                </div>
                            </form>
                            <form onSubmit={handleSubmitComplete(completeSubmit)} id={ganttStyles['complete-form']}>
                                    {
                                        isEditing && selectedPlan.estado === 0 || selectedPlan.estado === 1
                                            ? null
                                            : <button type='submit' id={ganttStyles['complete-btn']}>Completar</button>
                                    }
